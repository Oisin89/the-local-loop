          ...
          <div className="login-card">
            <div className="login-logo">
              <svg width="52" height="52" viewBox="0 0 52 52" fill="none">
                <circle cx="26" cy="26" r="26" fill="var(--accent-bg)" />
                <path d="M26 10c0 0-10 8-10 17a10 10 0 0 0 20 0c0-9-10-17-10-17z" fill="var(--accent)" />
                <path d="M26 20c0 0-5 4-5 8a5 5 0 0 0 10 0c0-4-5-8-5-8z" fill="var(--accent-dark)" />
              </svg>
            </div>
